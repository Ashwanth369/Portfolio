...
const { email, github, linkedin, resume } = profile.contact; // Make sure you add resume URL in profile.json
  ...
  return (
    <section className={styles.contact}>
      ...
      <div className={styles.contact_buttons}>
        ...
        <a href={resume} className={styles.button} target="_blank" download>
